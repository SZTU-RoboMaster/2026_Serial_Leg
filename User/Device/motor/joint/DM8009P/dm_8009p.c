...
void set_left_dm8009p_MIT(Dm8009P *left_motor, float pos, float speed, float kp, float kd, float torque)
{
    LeftJointTxFrame.Header.Identifier = left_motor->id;
...
void set_right_dm8009p_MIT(Dm8009P *right_motor, float pos, float speed, float kp, float kd, float torque)
{
    RightJointTxFrame.Header.Identifier = right_motor->id;
