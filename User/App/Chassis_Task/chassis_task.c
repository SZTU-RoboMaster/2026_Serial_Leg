...
/* =========================== 获取底盘传感器数据 =========================== */
    ...
    static void get_IMU_info(void)
    {
        ...
        /* =========================== Pitch =========================== */
            ...
            chassis.imu_reference.pitch_rad = DM_IMU.pitch * DEGREE_TO_RAD;

        /* =========================== Roll =========================== */

            chassis.imu_reference.roll_rad = DM_IMU.roll * DEGREE_TO_RAD;

        /* =========================== 更新各轴角速度(rad/s) =========================== */

            chassis.imu_reference.pitch_gyro = DM_IMU.gyro[X];
            chassis.imu_reference.yaw_gyro = DM_IMU.gyro[Y];
            chassis.imu_reference.roll_gyro = DM_IMU.gyro[Z];

        /* =========================== 更新各轴加速度 =========================== */

            /* =========================== 更新各轴加速度 =========================== */

                chassis.imu_reference.ax = DM_IMU.accel[X];
                chassis.imu_reference.ay = DM_IMU.accel[Y];
    ...
    static void chassis_variable_update(void)
    {
        ...
        /* =========================== θ θ' θ'' =========================== */
            ...
            /* =========================== θ =========================== */
                ...
                /* iss：原来θ_raw是（φ_0+pitch_rad)-pi/2 */
            ...
            /* =========================== θ' =========================== */
                ...
                /* =========================== θ' =========================== */
                    ...
                    /* iss：原来θ_dot_raw是φ_0+pitch_gyro */
    ...
    static void wheel_calc(void)
    {
        ...
        /* ============================= 3.2 加入目标输入 ============================= */
            ...
            chassis.leg_L.wheel_torque =
                - wheel_K_L[0] * (chassis.leg_L.state_variable_feedback.theta - THETA_OFFSET)
                ...
                - wheel_K_L[4] * (chassis.leg_L.state_variable_feedback.phi - PHI_OFFSET)
                - wheel_K_L[5] * (chassis.leg_L.state_variable_feedback.phi_dot - 0.0f);

            chassis.leg_R.wheel_torque =
                - wheel_K_R[0] * (chassis.leg_R.state_variable_feedback.theta - THETA_OFFSET)
                ...
                - wheel_K_R[4] * (chassis.leg_R.state_variable_feedback.phi - PHI_OFFSET)
...
/* ============================= 4. 计算力矩 关节 ============================= */
    ...
    static void joint_calc(void)
    {
        ...
        /* ============================= 4.2 根据机械结构加负号 ============================= */
            ...
            chassis.leg_L.joint_F_torque = - chassis.leg_L.joint_F_torque;
            chassis.leg_L.joint_B_torque = - chassis.leg_L.joint_B_torque;
...
/* ============================= 倒地自救 ============================= */
    ...
    static void chassis_selfhelp(void)
    {
        ...
        /* ============================= 恢复到低腿长位置 ============================= */
            ...
            if (joint[LF].pos_r > 0.0f || joint[RF].pos_r > 0.0f || joint[LB].pos_r > 0.0f || joint[RB].pos_r > 0.0f)
            {
                ...
                chassis.leg_L.speed = 10;
                chassis.leg_R.speed = 10;
                chassis.leg_L.kd = 5;
                chassis.leg_R.kd = 5;
            ...
            float R_speed, float R_Kd)
    {
        ...
        /* =========================== 关节8009P电机 =========================== */
            ...
            /* =========================== 左关节8009P电机 MIT模式 =========================== */
                ...
                set_left_dm8009p_MIT(&joint[LF], 0.0f, L_speed, 0.0f, L_Kd, joint_LF_torque);
                set_left_dm8009p_MIT(&joint[LB], 0.0f, L_speed, 0.0f, L_Kd, joint_LB_torque);

            /* =========================== 右关节8009P电机 MIT模式 =========================== */

                set_right_dm8009p_MIT(&joint[RF], 0.0f, R_speed, 0.0f, R_Kd, joint_RF_torque);
                set_right_dm8009p_MIT(&joint[RB], 0.0f, R_speed, 0.0f, R_Kd, joint_RB_torque);
    ...
    void chassis_task(void)
    {
        ...
        /* =========================== 发送力矩 =========================== */
            ...
            MIT_send_torque_task(chassis.leg_L.joint_F_torque,
                                 ...
                                 chassis.leg_L.wheel_torque,
                                 chassis.leg_R.wheel_torque,
                                 chassis.leg_L.speed,chassis.leg_L.kd,
                                 chassis.leg_L.speed,chassis.leg_L.kd);
